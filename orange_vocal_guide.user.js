...
// @match        https://www.guidevocal.fr.orange-business.com/vocalmestre2/service.jsf
...
function updateDate() {
    if(isValidityVisible()) {
        var selected = $("img[src='/vocalmestre2/static/images/tree/transfer_tr_sel.gif']").closest(".rf-tr-nd").index()-1;
